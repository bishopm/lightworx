...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('lightworx/css/leaflet.css') }}">
  ...
  <link rel="stylesheet" href="{{ asset('lightworx/css/custom.css') }}">    
</head>
    ...
    <nav class="navbar navbar-expand-lg bg-dark fixed-top" data-bs-theme="dark">
      <div id="container" class="container-fluid">
        <a href="{{url('/')}}" class="navbar-brand">
          ...
          <!-- <img src="{{ asset('lightworx/img/logo.png') }}" alt=""> -->
